...
```
## Microsoft Foundry Icon (Custom)

Azure2内蔵ライブラリにMicrosoft Foundryの新アイコンがない場合は、
`.github/skills/drawio-mcp-diagramming/references/microsoft-foundry.svg` を使用すること。

mxCellのstyle文字列:
image;aspect=fixed;html=1;image=.github/skills/drawio-mcp-diagramming/references/microsoft-foundry.svg;
